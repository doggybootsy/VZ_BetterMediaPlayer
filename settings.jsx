...
module.exports = class Settings extends React.PureComponent {
	...
	render() {
		...
		return (
            <>
                <Category title="Demo" description="little preview" icon={
                    <svg viewBox="0 0 30 30" width="2rem" height="2rem" style={{
                        padding: ".25rem"
                    }}>
                ...
                <Category title="Loop" description="Loop configuration" icon={
			        <svg width="1.75rem" height="2rem" style={{
                        padding: ".5rem"
                    }} viewBox="-5 0 459 459.648" xmlns="http://www.w3.org/2000/svg">
